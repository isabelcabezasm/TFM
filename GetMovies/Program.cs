...
namespace GetMovies
{
    class Program
    {
        ...
        private static async Task GetTopRatedMovies2021Async(TMDbClient client)
        {
            var dMovie = await client.DiscoverMoviesAsync()
                                    .WherePrimaryReleaseDateIsAfter(new DateTime(2021, 01, 01))
                                    .WherePrimaryReleaseDateIsBefore(new DateTime(2022, 01, 01))
